...
var _ = BeforeSuite(func() {
	var err error
	pathToFakeAgent, err = gexec.Build("github.com/springernature/consul-release/src/confab/fakes/agent")
	Expect(err).NotTo(HaveOccurred())

	pathToConfab, err = gexec.Build("github.com/springernature/consul-release/src/confab/confab")
	Expect(err).NotTo(HaveOccurred())
})
